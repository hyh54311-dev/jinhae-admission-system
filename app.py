...
<body style="font-family: 'Malgun Gothic', 'Noto Sans KR', sans-serif; background-color: #ffffff; padding: 0; margin: 0;">
  ...
  <!-- Outer border box is the MAIN table, with 4 columns -->
    ...
    <tr>
      <td style="padding: 20px 20px; vertical-align: top;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse; table-layout: fixed;">
          <!-- Column definitions to enforce exact widths natively in Google Docs -->
          <colgroup>
            <col style="width: 48%;"> <!-- Spacer column to push content right -->
            <col style="width: 17%;"> <!-- Label column -->
            <col style="width: 15%;"> <!-- Value / Colon column -->
            <col style="width: 20%;"> <!-- Value / Signature image column -->
          </colgroup>
          
          <!-- Title Header -->
          <tr>
            <td colspan="4" align="center" style="padding-top: 5px; padding-bottom: 10px;">
          ...
          <!-- Info block (Directly in main table rows) -->
          <tr>
            <td></td> <!-- Spacer -->
            <td style="font-weight: bold; padding: 6px 0; font-size: 14px; letter-spacing: 0.1em;">접 수 번 호</td>
            <td style="padding: 6px 5px; font-weight: bold; font-size: 14px; text-align: center;">:</td>
            <td style="border-bottom: 1px solid #94a3b8; padding: 6px 5px; font-size: 14px; color: #334155;">{student_id}</td>
          </tr>
          <tr>
            <td></td> <!-- Spacer -->
            <td style="font-weight: bold; padding: 6px 0; font-size: 14px; letter-spacing: 0.2em;">성&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;명</td>
            <td style="padding: 6px 5px; font-weight: bold; font-size: 14px; text-align: center;">:</td>
            <td style="border-bottom: 1px solid #94a3b8; padding: 6px 5px; font-size: 14px; color: #334155;">{student_name}</td>
          </tr>
          <tr>
            <td></td> <!-- Spacer -->
            <td style="font-weight: bold; padding: 6px 0; font-size: 14px; letter-spacing: 0.1em;">출신중학교</td>
            <td style="padding: 6px 5px; font-weight: bold; font-size: 14px; text-align: center;">:</td>
            <td style="border-bottom: 1px solid #94a3b8; padding: 6px 5px; font-size: 14px; color: #334155;">{school_name}</td>
          </tr>
          <tr>
            <td></td> <!-- Spacer -->
            <td style="font-weight: bold; padding: 6px 0; font-size: 14px; letter-spacing: 0.1em;">생 년 월 일</td>
            <td style="padding: 6px 5px; font-weight: bold; font-size: 14px; text-align: center;">:</td>
            <td style="border-bottom: 1px solid #94a3b8; padding: 6px 5px; font-size: 14px; color: #334155;">{birth_date}</td>
          </tr>
          
          <!-- Pledge Statement -->
          <tr>
            <td colspan="4" align="center" style="font-size: 15px; font-weight: bold; line-height: 1.6; padding: 20px 0; color: #000000; text-align: center;">
          ...
          <!-- Date -->
          <tr>
            <td colspan="4" align="center" style="font-size: 14px; font-weight: bold; padding: 10px 0; text-align: center; color: #000000;">
              2027년   1월   4일
            </td>
          </tr>
          
          <!-- Student Signature Block (Directly in main table rows) -->
          <tr>
            <td></td> <!-- Spacer -->
            <td style="font-weight: bold; padding: 8px 0; font-size: 15px; letter-spacing: 0.2em;">학&nbsp;&nbsp;&nbsp;생 :</td>
            <td style="border-bottom: 1px solid #94a3b8; text-align: center; padding: 8px 5px; font-size: 15px;">{student_name}</td>
            <td style="border-bottom: 1px solid #94a3b8; text-align: center; padding: 0 5px; vertical-align: middle;">
          ...
          <tr>
            <td></td> <!-- Spacer -->
            <td style="font-weight: bold; padding: 8px 0; font-size: 15px; letter-spacing: 0.2em;">보호자 :</td>
            <td style="border-bottom: 1px solid #94a3b8; text-align: center; padding: 8px 5px; font-size: 15px;">{parent_name}</td>
            <td style="border-bottom: 1px solid #94a3b8; text-align: center; padding: 0 5px; vertical-align: middle;">
          ...
          <!-- Dean Seal/Name -->
          <tr>
            <td colspan="4" align="center" style="font-size: 20px; font-weight: bold; color: #000000; padding-top: 15px; padding-bottom: 5px; text-align: center; letter-spacing: 0.05em;">
              진해고등학교장 귀하
            </td>
          </tr>
