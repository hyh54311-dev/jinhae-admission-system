...
<body style="font-family: 'Malgun Gothic', 'Noto Sans KR', sans-serif; background-color: #ffffff; padding: 0; margin: 0;">
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border: 2px solid #1c4587; width: 100%; max-width: 500pt; margin: 0 auto; border-collapse: collapse;">
    <tr>
      <td style="padding: 25px 25px; vertical-align: top;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
          ...
          <tr>
            <td align="right" style="padding-top: 10px; padding-bottom: 15px;">
              <table border="0" cellpadding="0" cellspacing="0" style="font-size: 14px; margin-right: 15px; text-align: left; width: 280px;">
                <tr>
                  <td style="font-weight: bold; padding: 5px 0; width: 90px; letter-spacing: 0.1em;">접 수 번 호</td>
                  <td style="padding: 5px; font-weight: bold; width: 20px; text-align: center;">:</td>
                  <td style="border-bottom: 1px solid #94a3b8; width: 170px; padding: 5px; color: #334155;">{student_id}</td>
                </tr>
                <tr>
                  <td style="font-weight: bold; padding: 5px 0; width: 90px; letter-spacing: 0.2em;">성&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;명</td>
                  <td style="padding: 5px; font-weight: bold; width: 20px; text-align: center;">:</td>
                  <td style="border-bottom: 1px solid #94a3b8; width: 170px; padding: 5px; color: #334155;">{student_name}</td>
                </tr>
                <tr>
                  <td style="font-weight: bold; padding: 5px 0; width: 90px; letter-spacing: 0.1em;">출신중학교</td>
                  <td style="padding: 5px; font-weight: bold; width: 20px; text-align: center;">:</td>
                  <td style="border-bottom: 1px solid #94a3b8; width: 170px; padding: 5px; color: #334155;">{school_name}</td>
                </tr>
                <tr>
                  <td style="font-weight: bold; padding: 5px 0; width: 90px; letter-spacing: 0.1em;">생 년 월 일</td>
                  <td style="padding: 5px; font-weight: bold; width: 20px; text-align: center;">:</td>
                  <td style="border-bottom: 1px solid #94a3b8; width: 170px; padding: 5px; color: #334155;">{birth_date}</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <!-- Pledge Statement -->
          <tr>
            <td align="center" style="font-size: 15px; font-weight: bold; line-height: 1.6; padding: 30px 0; color: #000000; text-align: center;">
          ...
          <!-- Date -->
          <tr>
            <td align="center" style="font-size: 14px; font-weight: bold; padding: 15px 0; text-align: center; color: #000000;">
              2027년   1월   4일
            </td>
          </tr>
          ...
          <tr>
            <td align="right" style="padding-top: 15px; padding-bottom: 25px;">
              <table border="0" cellpadding="0" cellspacing="0" style="font-size: 14px; margin-right: 15px; text-align: left; width: 300px;">
                
                <!-- Student Signature -->
                <tr>
                  <td style="font-weight: bold; padding: 8px 0; width: 70px; letter-spacing: 0.2em; font-size: 15px;">학&nbsp;&nbsp;&nbsp;생 :</td>
                  <td style="border-bottom: 1px solid #94a3b8; width: 90px; text-align: center; padding: 8px 5px; font-size: 15px;">{student_name}</td>
                ...
                <!-- Parent Signature -->
                <tr>
                  <td style="font-weight: bold; padding: 8px 0; letter-spacing: 0.2em; font-size: 15px;">보호자 :</td>
                  <td style="border-bottom: 1px solid #94a3b8; width: 90px; text-align: center; padding: 8px 5px; font-size: 15px;">{parent_name}</td>
                  <td style="border-bottom: 1px solid #94a3b8; width: 120px; text-align: center; padding: 0 5px; vertical-align: middle;">
          ...
          <!-- Dean Seal/Name -->
          <tr>
            <td align="center" style="font-size: 20px; font-weight: bold; color: #000000; padding-top: 25px; padding-bottom: 15px; text-align: center; letter-spacing: 0.05em;">
              진해고등학교장 귀하
            </td>
          </tr>
