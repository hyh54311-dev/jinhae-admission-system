...
# 타이틀 (큼직하고 명확하게)
ax.text(50, 93, "[1도 출판용] 주식·ETF 투자 5대 핵심 계좌 마인드맵", fontsize=18, fontweight='bold', ha='center', color='#000000')
ax.text(50, 87, "내 투자 목적과 기간에 맞는 계좌 구조를 한눈에 파악하세요", fontsize=11, ha='center', color='#333333')
...
# 1차 서브 노드 (좌측: 매매 계좌 / 우측: 파킹 계좌)
# 연결선
ax.plot([35, 23], [45, 68], color='#000000', linewidth=2, linestyle='-')
ax.plot([35, 23], [45, 22], color='#000000', linewidth=2, linestyle='-')
ax.plot([65, 77], [45, 45], color='#000000', linewidth=2, linestyle='-')
...
print(f"SUCCESSFULLY GENERATED MONO MINDMAP AT {chart_path}")
