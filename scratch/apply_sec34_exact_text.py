...
target_sec34_insert = """### 3.4 연금저축 최적화 ETF 라인업과 환노출 방패막 및 안전자산 대피 메커니즘"""

repl_sec34_insert = """### 3.4 Antigravity Vibe Coding 기반 K-듀얼모멘텀 파이썬 소스 코드 및 텔레그램 엔진
...
if target_sec34_insert in text:
    text = text.replace(target_sec34_insert, repl_sec34_insert)
