...
| :--- | :--- | :--- | :--- |
| **한글 성명** | **황요한** | **유승화** | **이영근** |
| **영문 성 (Surname)** | **HWANG** | **YOO** | LEE *(예약 시 확인)* |
| **영문 이름 (Given Name)** | **YOHAN** | **SEUNGHWA** | YEONGGEUN *(예약 시 확인)* |
| **여권 번호** | **`M885J9226`** | **`M88568510`** | **`M370F2483`** |
| **생년월일** | **1986. 08. 21** | **1983. 08. 29** | *(예약 시 확인)* |
| **성별** | **M (남성)** | **M (남성)** | **M (남성)** |
| **기간 만료일** | **2032. 12. 21** | **2028. 10. 26** | **2036. 07** |
...
* **육류 및 육가공품 전면 금지:** 육포, 햄, 소시지, 만두, **고기 성분 포함 컵라면/스프** 반입 금지 (적발 시 1차 20만 TWD, **한화 약 850만 원 벌금**).
